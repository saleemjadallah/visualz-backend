...
async function testAIThreeJSCelebratoryIntegration() {
    try {
        ...
        sceneGroup.traverse((object) => {
            if (object.userData) {
                if (object.userData.component?.includes('celebratory'))
                    celebratoryCount++;
                if (object.userData.component?.includes('balloon'))
                    balloonCount++;
                if (object.userData.component?.includes('backdrop'))
                    backdropCount++;
                if (object.userData.component?.includes('interactive'))
                    interactiveCount++;
                if (object.userData.component?.includes('gift'))
                    giftDisplayCount++;
                if (object.userData.component?.includes('ceremonial'))
                    ceremonialCount++;
            }
        });
